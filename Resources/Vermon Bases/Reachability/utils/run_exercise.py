...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir, pcap_dir,
                       switch_json, bmv2_exe='simple_switch', quiet=False, username=None):
        ...
        self.hosts_per_node = topo['hosts_per_node']
    ...
    def run_exercise(self):
        ...
        cmd = ['sudo', 'python3', 'report-receiver.py', str(len(self.switches) - 1), str(self.username), str(self.hosts_per_node)]
...
if __name__ == '__main__':
    ...
    exercise = ExerciseRunner(args.topo, args.log_dir, args.pcap_dir,
                              args.switch_json, args.behavioral_exe, args.quiet, args.username)
